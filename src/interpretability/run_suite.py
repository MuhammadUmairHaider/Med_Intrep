...
def main():
    ...
    parser.add_argument("--model_id", type=str, default="google/medgemma-1.5-4b-it", help="Model ID or path")
    parser.add_argument("--output_dir", type=str, default="reports/interpretability", help="Output directory")
    parser.add_argument("--num_samples", type=int, default=10, help="Number of samples for latent analysis")
    ...
    if len(generated_ids) > 0:
        ...
        print("No tokens generated, skipping IG.")
