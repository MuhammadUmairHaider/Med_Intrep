...
def get_attention_weights(model, tokenizer, text, layer_idx: int = -1, head_idx: Optional[int] = None):
    """
...
def plot_attention_heatmap(attn_matrix: np.ndarray, tokens: List[str], title: str = "Attention Weights", save_path: Optional[str] = None):
    """
